-- Update get_snippets_preview function to include proper fields for rendering
...
BEGIN
    ...
    CREATE TEMP TABLE filtered_snippets AS
        SELECT
            ...
            -- Add political_leaning field for showing labels
            jsonb_build_object('score', (s.confidence_scores->>'overall')::INTEGER) AS political_leaning,
            -- Add confidence score level
        ...
        ORDER BY 
            CASE
                WHEN p_order_by = 'upvotes' THEN s.upvote_count + like_counts.likes
