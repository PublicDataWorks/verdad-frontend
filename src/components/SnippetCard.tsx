...
const SnippetCard: React.FC<SnippetCardProps> = ({ snippet, searchTerm = '', onSnippetClick }) => {
  ...
  return (
    <div
      ...
      <div className='mb-2 flex items-start justify-between' data-testid='snippet-card'>
        <h3 className='cursor-pointer text-lg font-medium' data-testid='snippet-title'>
      ...
      <p className='mb-4 text-xs text-zinc-400' data-testid='snippet-subtitle'>
        {getSnippetSubtitle(snippet, language)}
      </p>
      <p className='mb-4' data-testid='snippet-summary'>
        {highlightText(snippet?.summary, searchTerm)}
      </p>
